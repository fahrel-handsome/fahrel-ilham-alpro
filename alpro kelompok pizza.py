print("Selamat datang di Anam's Pizza")
pizza = input("Atas nama siapa sayang? : ")
...
if pizzahut5 == 1:
    pizzahut1 = int(input("Mau makan Pizza apa hari ini sayangg?\nketik 1 untuk melihat menu Pizza hari ini\n: "))
elif pizzahut5 == 2:
...
if pizzahut1 == 1:
    ...
    if pizzahut3 == 1:
        ...
        print("Maaf, list yang kamu masukan tidak ada dalam menu ya sayangg kami kali ini. Silahkan ulangi pesananmu.")
        exit()

# Melanjutkan pesanan dengan memilih topping
pizza1 = int(input("ketik 1 untuk melanjutkan pesananmu : "))
original = 0
StuffedCrustCheese = 50000
StuffedCrustSausage = 45000
CheesyBites = 35000
EkstraKeju = 13000
...
print(f"Terima kasih sudah memesan Anam's Pizza, Total harga pesananmu adalah: Rp {total_harga}")
